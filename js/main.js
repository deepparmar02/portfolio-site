...
(function ($) {
  ...
  document.addEventListener("scroll", () => {
    ...
    sections.forEach((section) => {
      const sectionTop = section.offsetTop - 66; // Adjust for top-bar height
    ...
    if (topBar) {
      if (currentSection === "intro") {
        // Hide top-bar for Home section (intro)
        topBar.style.visibility = "hidden";
        topBar.style.opacity = 0;
      } else {
        // Show top-bar for all other sections
    ...
    if (logo) {
      if (currentSection === "intro") {
        // Hide logo for Home section
        logo.style.visibility = "hidden";
      } else {
        // Show logo for all other sections
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    toggleButton.addEventListener("click", function () {
      hiddenExperiences.forEach((block) => {
        block.style.display =
